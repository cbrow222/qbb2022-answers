...
ax.set_ylabel("K562 Expression levels (log10)")
xseq=np.linspace(max(min(k562_model_predictions),min(k562_observations)),min(max(k562_model_predictions),max(k562_observations)),100)
ys=0+1*xseq
ax.plot(xseq,ys, color = "maroon")
